...
import isIslandScene from "../assets/modal.glb";
...
export function Model({ isRotating, setIsRotating,setCurrentStage, ...props }) {
  ...
  const handlePointerDown = (e) => {
    ...
    e.preventDefault();
    setIsRotating(true);
    const clientX = e.touches ? e.touched[0].clientX : e.clientX;
  ...
  const handlePointerMove = (e) => {
    console.log("CHECKING CALLED",isRotating)
        ...
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              <group name="Plane_2" scale={200.623}>
                <mesh
                  name="Object_4"
                  //   castShadow
                  //   receiveShadow
